<template>
  ...
  <v-layout column align-center>
    <div class='headline font-weight-bold' aria-label='Company Name'>{{ companyname }}</div>
  ...
  <v-card id='contact' raised color='white' height='auto'>
    ...
    <v-card-text>
      <p class='title'>        
        ...
        <v-btn flat icon color='primary' v-on:click='customTextToClipboard1' aria-label='Copy Telephone Number 2'><v-icon>content_copy</v-icon></v-btn>
      </p>
      <p class='title'>
	      <v-icon>phone</v-icon><a href='tel:' {{ telnum2 }}>{{ telnum2 }}</a><span> </span>
        <v-btn flat icon color='primary' v-on:click='customTextToClipboard2' aria-label='Copy Telephone Number 1'><v-icon>content_copy</v-icon></v-btn>
      </p>
    </v-card-text>
  </v-card>    
  <!-- End Contact -->
  ...
  <v-card id='hours' raised color='white' height='auto'>
    ...
    <v-card-title>
      <div class="subheading font-weight-bold">{{ Hours2 }}</div>     
    </v-card-title>
    <v-divider></v-divider>
    <v-card-title>
      <div class="title font-weight-bold">{{ Hours3 }}</div>
    </v-card-title>
    <v-card-title>
      <div class="subheading font-weight-bold">{{ Hours4 }}</div>
    </v-card-title>
   <v-divider></v-divider>
    <v-card-title>
      <div class="title font-weight-bold">Open 7 Days a Week</div>
    </v-card-title>
    <v-divider></v-divider>
    <v-card-title>
      <div class="subheading font-italic font-weight-bold">We take advance reservations for those with Late/Early work schedules.</div>
      </v-card-title>
  </v-card>
  <!-- End Hours -->
  <!-- Begin Pricing -->
  <v-card id='pricing' raised color='white' height='auto'>
    ...
    <v-card-title>
      <div class="title font-weight-bold">{{ oneWayPrice }}</div>
    </v-card-title>
    <v-card-title>
      <div class="title font-weight-bold">{{ roundTripPrice }}</div>
    </v-card-title>
    <v-card-title>
      <div class='title font-weight-bold'>{{ additionalStopPrice }}</div>
    </v-card-title>
    <hr>
    <v-card-title>
      <div class="subheading font-weight-bold font-italic">*With a wait time of up to 15 minutes. ($3 Additional charge if over 15 minutes.)</div>
    </v-card-title>
    <v-card-title>
      <div class="subheading font-weight-bold">Call dispatch for out of town pricing and availability.</div>      
    </v-card-title>
    <v-card-title>
      <div class="subheading font-weight-bold">Keep in mind we offer multiple specials for weekly rates & discount coupons that you can ask your driver about or dispatch.</div>
    </v-card-title>
    <hr>
  <v-card-title>
    <div class="subheading font-weight-bold font-italic">So far it's been a great experience & we thank you all for your support & hope you keep us in mind for your hometown cab needs.</div>
  </v-card-title>
  </v-card>
  <!-- End Pricing -->
  <!-- Begin Specials -->
  ...
  <v-card-title>
    <div class="subheading font-weight-bold font-italic">We offer discounts for Seniors and Veterans.</div>    
  </v-card-title>  
  </v-card>
  <!-- End Specials -->
  <!-- Begin Testimonials -->
  <v-card id='testimonials' raised color='white'>
    ...
    <v-card-title>
      <div class="title font-weight-bold font-italic">Kudos. HOMETOWN CAB!!!!</div>      
    </v-card-title>
  </v-card>
  <!-- End Testimonials -->
  <!-- End Main Content -->
